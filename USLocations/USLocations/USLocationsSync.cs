...
/*
 * My Synchronous implementation works
 * My Commons and Distance Projects work
 * 
 */
namespace USLocations {
	...
	public class USLocations
	{
		...
		{
			//var file = await AddDataAsync(fileName);
		...
		//public async Task<List<string[]>> AddDataAsync(string filename)
		//{
		...
		//		while (!input.EndOfStream)
		//		{
		//			Task<string> line = await input.ReadLineAsync();
		//			string line = 
		...
		{
			ISet<string> commonCities = new SortedSet<string>();
