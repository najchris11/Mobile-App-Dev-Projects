...
namespace ListViewCSTemplate {
    ...
    public class MainPage : ContentPage {
        ...
        public MainPage() {
            ...
            selectedSchool = new Label { Text = schoolList[1].WebsiteURL };
        ...
        private void ListView_ItemTapped(object sender, ItemTappedEventArgs e) {
            selectedSchool.Text = ((School)e.Item).WebsiteURL;
            wv.Source = ((School)e.Item).WebsiteURL;
        }
        ...
        public void ConfigureListView2(out ListView lv, ObservableCollection<School> schools)
        {
            ...
            lv.ItemTemplate = new DataTemplate(() => {
                ...
                //Makes a label for the URL
                Label urlLabel = new Label();
                urlLabel.SetBinding(Label.TextProperty, "WebsiteURL");
