...
namespace cs {
    public struct RectangleStruct {
        ...
        public override string ToString() { return string.Format("Struct ({0},{1},{2},{3})", lx, ly, rx, ry); }
    }
    public class RectangleClass {
        ...
        public override string ToString() { return string.Format("Class ({0},{1},{2},{3})", lx, ly, rx, ry); }
    }
